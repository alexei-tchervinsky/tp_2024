...
void gredasov::getHelpCommand(std::ostream& out, std::istream& in)
{
  if (in.peek() != '\n')
  {
...
void gredasov::createCommand(dictionaries& dicts, std::ostream& out, std::istream& in)
{
  if (in.peek() == '\n')
  {
    throw std::invalid_argument("Error");
  ...
  out << "Dictionary was successfully created\n";
}

void gredasov::showDictionaryCommand(dictionaries& dicts, std::ostream& out, std::istream& in)
{
  if (in.peek() == '\n')
  {
    throw std::invalid_argument("Error");
...
void gredasov::showTopCommand(dictionaries& dicts, std::ostream& out, std::istream& in)
{
  if (in.peek() == '\n')
  {
    throw std::invalid_argument("Error");
...
void gredasov::searchCommand(dictionaries& dicts, std::ostream& out, std::istream& in)
{
  if (in.peek() == '\n')
  {
    throw std::invalid_argument("Error");
  ...
  else
  {
    ...
    {
      throw std::invalid_argument("Wrong command after <filename>");
    }
  }
}

void gredasov::deleteCommand(dictionaries& dicts, std::ostream& out, std::istream& in)
{
  if (in.peek() == '\n')
  {
    throw std::invalid_argument("Error");
...
void gredasov::getIntersectionsCommand(dictionaries& dicts, std::ostream& out, std::istream& in)
{
  if (in.peek() == '\n')
  {
    throw std::invalid_argument("Error");
  ...
  else
  {
    ...
    if (flag)
    {
      out << "Dictionary intersections were successfully obtained\n";
    }
    else
    {
      out << "Dictionaries don't intersect\n";
    }
  }
}

void gredasov::mergeCommand(dictionaries& dicts, std::ostream& out, std::istream& in)
{
  if (in.peek() == '\n')
  {
    throw std::invalid_argument("Error");
...
void gredasov::getAllCommand(dictionaries& dicts, std::ostream& out, std::istream& in)
{
  if (in.peek() == '\n')
  {
    throw std::invalid_argument("Error");
...
void gredasov::saveCommand(dictionaries& dicts, std::ostream& out, std::istream& in)
{
  if (in.peek() == '\n')
  {
    throw std::invalid_argument("Error");
...
void gredasov::sortCommand(dictionaries& dicts, std::ostream& out, std::istream& in)
{
