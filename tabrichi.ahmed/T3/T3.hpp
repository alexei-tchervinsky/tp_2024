...
void commandMin(const std::string& args,
    const std::vector<std::shared_ptr<Polygon>>& polygons);

void commandCount(const std::string& args,
    const std::vector<std::shared_ptr<Polygon>>& polygons);

void commandLessArea(const std::string& args,
    const std::vector<std::shared_ptr<Polygon>>& polygons);

void commandSame(const std::string& args,
    const std::vector<std::shared_ptr<Polygon>>& polygons);
