  ...
  std::istream &in, std::ostream &out)
  {
    ...
    else
    {
      ...
      if (argument == "COMMAND")
      {
        ...
        "3.'CLOSE <none/SAVE>' - закрывает файл сохраняя или нет изменения по "<<
        "желанию пользователя.\n"<<
        "4.'COMPARE <path>' - "<<
        "считвыает словарь из файла и сравнивает сколько ключей повторяется в двух словарях.\n"<<
        ...
        "8.'CHANGE {<word> - <translation>}' - заменяет уже существующий ключ и переводы "<<
        "на новое.\n"<<
