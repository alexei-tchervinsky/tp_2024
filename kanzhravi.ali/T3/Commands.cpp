...
void AliKn::AreaVersNum(std::size_t vertexes, const std::vector<Polygon>& polygons, std::ostream& out)
{
...
double AliKn::sumAreas(const std::vector<Polygon>& polygons)
{
...
double AliKn::getArea(const Polygon& polygon)
{
...
void AliKn::Max(const std::vector<Polygon>& polygons, std::ostream& out, std::istream& in)
{
...
void AliKn::maxVertexes(const std::vector<Polygon>& polygons, std::ostream& out)
{
...
void AliKn::Count(const std::vector<Polygon>& polygons, std::ostream& out, std::istream& in)
{
...
void AliKn::CountEven(const std::vector<Polygon>& polygons, std::ostream& out)
{
...
void AliKn::CountOdd(const std::vector<Polygon>& polygons, std::ostream& out)
{
...
void AliKn::CountVertexes(std::size_t vertexes, const std::vector<Polygon>& polygons, std::ostream& out)
{
...
void AliKn::Perms(const std::vector<Polygon>& polygons, std::ostream& out, std::istream& in)
{
...
bool AliKn::checkPerms(const Polygon& left, const Polygon& right)
{
...
bool AliKn::checkPoints(const Polygon& polygon, const Point& point)
{
...
void AliKn::Rightshapes(const std::vector<Polygon>& polygons, std::ostream& out)
{
    std::size_t count = std::count_if(polygons.begin(), polygons.end(), isRightAngle);
    out << count << '\n';
}

bool AliKn::isRightAngle(const Polygon& polygon)
{
...
AliKn::Point AliKn::vectorOnCoords(const AliKn::Point& firstPoint, const AliKn::Point& secondPoint)
{
    return AliKn::Point{ secondPoint.x - firstPoint.x, secondPoint.y - firstPoint.y };
}

double AliKn::cosFromVects(const AliKn::Point& firstPoint, const AliKn::Point& secondPoint)
{
