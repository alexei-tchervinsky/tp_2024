...
int main()
{
    ...
    std::istringstream iss("{ \"key1\": 20D, \"key2\": 89l,\"key3\": \"Data1\" }");
    ...
    std::istringstream iss2("{ \"key1\": 15D, \"key2\": 21l,\"key3\": \"Git fetch\" }");
    ...
    std::istringstream iss3("{ \"key1\": 3D, \"key2\": 34l,\"key3\": \"Git push\" }");
    ...
    std::istringstream iss4("{ \"key1\": 3D, \"key2\": 38l,\"key3\": \"Git\" }");
