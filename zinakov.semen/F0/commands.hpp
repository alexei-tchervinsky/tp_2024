...
namespace semzin
{
  ...
  void sortMtoL(std::unordered_map<std::string, std::size_t> &frequencyDict, std::istream &in, std::ostream &out);
  void sortLtoM(std::unordered_map<std::string, std::size_t> &frequencyDict, std::istream &in, std::ostream &out);
  void print(std::unordered_map<std::string, std::size_t> &frequencyDict, std::ostream &out);
  void holyTrinityMost(std::unordered_map<std::string, std::size_t> &frequencyDict, std::istream &in, std::ostream &out);
  void holyTrinityLeast(std::unordered_map<std::string, std::size_t> &frequencyDict, std::istream &in, std::ostream &out);
