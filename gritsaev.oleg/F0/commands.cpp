        ...
        else
        {
            ...
            if (argument == "COMMAND")
            {
                out <<
                    ...
                    "йл сохран€€ или нет изменени€ по " <<
                    "желанию пользовател€.\n" <<
                    "4.'COMPARE <path>' - " <<
                    "считвыает словарь из файла и сравнивает ско" <<
                    "лько ключей повтор€етс€ в двух словар€х.\n" <<
                    "5.'INSERT {<word> - <translation>}' - вставл€ет в словарь но" <<
                    "вое слово и перевод," <<
                    "если ключ уже существует то доплон€ет перевод.\n" <<
                    "6.'DELETE <word>' - удал€ет из слово и все переводы.\n" <<
                    "7.'SEARCH <word>' - находит в словаре слово и выв" <<
                    "одит found или not found.\n" <<
                    "8.'CHANGE {<word> - <translation>}' - замен" <<
                    "€ет уже существующий ключ и переводы " <<
                    "на новое.\n" <<
