...
namespace lelkov
{
    ...
    void Graph::inputGraph()
    {
        for (int i = 0; i < n; ++i)
        {
            ...
            for (int j = 0; j < n; ++j)
            {
                ...
                while (true)
                {
                    ...
                    {
                        std::cout << "Некорректный ввод. Вес ребра должен быть "
                                  << "положительным числом больше нуля или 'e', "
                                  << "если ребра нет.\n";
                        std::cin.clear();
                        std::cin.ignore(
        ...
        for (int i = 0; i < n; ++i)
        {
            for (int j = 0; j < i; ++j)
            {
                ...
                {
                    clearGraph();
                    throw std::runtime_error("Граф не является симметричным. "
                                             "Граф удален.");
                }
            }
        }
    ...
    {
        std::cout << "Введите номер вершины, которую хотите удалить или -1 "
                  << "чтобы выбрать другой алгоритм: ";
        int node;
        std::cin >> node;
        if (node == -1)
        {
    ...
    void Graph::addEdge()
    {
        ...
        std::cout << "Введите из какой вершины провести ребро, или -1 чтобы "
        ...
        {
            throw std::runtime_error("Некорректный ввод! Вершина должна быть в "
                                     "диапазоне от 1 до " +
                                     std::to_string(n));
        }
    ...
    {
        int start, end;
        std::cout << "Введите вершину, из которой хотите удалить ребро, или -1 "
                  << "чтобы выбрать другой алгоритм: ";
        std::cin >> start;
        if (start == -1)
        {
        ...
        {
            throw std::runtime_error("Некорректный ввод! Ребро между данными "
    ...
    {
        int weight;
        std::cout << "Введите вес искомого ребра, или -1 чтобы выбрать другой "
                  << "алгоритм: ";
        std::cin >> weight;
        if (weight == -1)
        {
        ...
        if (weight <= 0)
        {
            throw std::runtime_error("Некорректный ввод! Ребро должно иметь "
                                     "вес больше 0");
        }
        ...
        for (int i = 0; i < n; ++i)
        {
            for (int j = i + 1; j < n; ++j)
            {
                ...
                {
                    hasEdges = true;
                    std::cout << "Ребро весом " << weight << " есть между "
                              << "вершинами " << i + 1 << " и " << j + 1
                              << std::endl;
                }
            }
        ...
        if (!hasEdges)
        {
            std::cout << "Ребра весом " << weight << " не существует"
                      << std::endl;
        }
    }
